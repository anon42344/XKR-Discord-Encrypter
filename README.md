...
Enter the password for your server, and add optional password for your channel. Press the icon to activate. After you typed your message, press § (usually under esc button) to encrypt a message.
